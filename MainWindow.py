...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QWidget.setTabOrder(self.date1Edit, self.listWidget1)
        QWidget.setTabOrder(self.listWidget1, self.date2Edit)
        QWidget.setTabOrder(self.date2Edit, self.listWidget2)
