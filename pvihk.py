...
# Hier steckt die Optimierungsroutine drinnen
# durch den Optimierungsblock kann man sie nur schwer unterbrechen
# def berechne_korrektorenverteilung(eingabedaten) -> dict:
#     """
#     Optimiert die Korrektorenverteilung und erzeugt ein PDF.
#
#     Eingabe:
#         eingabedaten: dict mit
#             - 'verfügbarkeiten': {Korrektor: [Datum1, Datum2, ...]}
#             - 'kandidaten': {Nr: Name}
#             - 'pruefungstage': [Datum1, Datum2]
#             - 'anzahl_korrektoren_pro_klausur': 2
#
#     Rückgabe:
#         dict mit
#             - 'pdf_data': PDF-Datei als Bytes
#             - 'verteilung': {Datum: Liste von (Zeit, Prüfling, [Korrektor1, Korrektor2])}
#     """
#     # ================= Vorbereitung =================
...
#
#     # TODO: später im Einstellungsdialog konfigurierbar machen !
...
#
#     sortierte_zeiten = [
#         [datetime.strptime(z, "%H:%M").time() for z in tag_zeiten]
#         for tag_zeiten in zeitslots
#     ]
#
...
#
#     # Verteilung auf die Tage mit A1 >= A2
...
#
#     # Solver mit Zeitlimit von 10 Sekunden
...
#
#     # heuristische Abschätzung, ob duch Abbruch das Ergebnis entstanden
#     if solver_status == "Optimal":
#         if solver_duration >= 9:  # fast gleich TimeLimit: wahrscheinlich Abbruch
...
#
#     # Versandoptimierung (Startpakete & Weitergaben)
...
#         sender = p1
#         empfaenger = p2
#         versand_start[sender].extend(klist)
#         weitergaben[(sender, empfaenger)].extend(klist)
#
#     # ================= PDF erzeugen =================
...
#     pdf.add_page()
#     pdf.set_font("Arial", "B", 14)
#     pdf.cell(0, 8, "Versand und Weitergabe der Klausuren", ln=True)
#     pdf.ln(5)
#
#     pdf.set_font("Arial", "B", 12)
#     pdf.cell(0, 6, "Anfangsverteilung (IHK)", ln=True)
...
#
#     pdf.set_font("Arial", "B", 12)
#     pdf.cell(0, 6, "Weitergabe", ln=True)
#     pdf.set_font("Arial", size=10)
...
#         "status": final_status    # <--- NEU, einfach dazufügen!
#     }
...
class MainWindow(QMainWindow,Ui_MainWindow):
    def __init__(self):
        ...
        icon_path = os.path.join(BASIS_DIR, "PVIHK.png")
